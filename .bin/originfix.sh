...
sudo sync -avP  "$wineprefix/drive_c/Program Files/Electronic Arts/EA Desktop/StagedEADesktop/EA Desktop/"  "$wineprefix/drive_c/Program Files/Electronic Arts/EA Desktop/EA Desktop/"
